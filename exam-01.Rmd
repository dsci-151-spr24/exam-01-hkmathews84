...
*I, Hailie Mathews, hereby state that I have not communicated with or gained information in any way from my classmates or anyone other than the Professor or TA during this exam, and that all work is my own.*
...
***The 10 most common destinations from NYC airports in 2013 were: LAX, ATL, ORD, SFO, CLT,BOS, MIA, MCO, DTW, and DFW.***
...
```{r}
flights %>%
  group_by(origin, carrier, year) %>%
  count() %>%
  arrange(desc(n)) %>%
  top_n(10)
```

***The 10 airlines with the most flights departing from NYC airports are: United Airlines (UA), Eve Air Alaska (EV), JetBlue Airways (B6), Delta Air Lines (DL), Envoy Air (MQ), American Airlines (AA), Endeavor Air (9E), US Airways (US), Southwest Airlines (WN), and Virgin America (VX).***
